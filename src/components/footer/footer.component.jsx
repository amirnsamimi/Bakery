...
const Footer = () => {
  return (
    <footer className=" relative rounded-tl-2xl  flex   border-r-[4rem] border-b-primary border-b-[4rem] border-transparent">
      <div className=" absolute w-full flex items-center justify-between  p-8 h-[50px] md:h-[50px]  ">
